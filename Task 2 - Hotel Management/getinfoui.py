...
import os
import pickle
#common list containing all the information regarding the guest
guest_details_list=[]
l2=[]
G = []

#accesses the dat file and saves information  
def file_save():
...
#this code was take from https://stackoverflow.com/questions/14907067/how-do-i-restart-a-program-based-on-user-input
def restart_program():
...
# window for the page 
#shows output and accepts input 
#takes in a room number and gives the details regarding the guest staying in respective room as the output 
    ...
    def __init__(self):
        def gotinfo():
            ...
            if self.gettininfo.isdigit() == True and len(self.gettininfo) != 0:
                self.Text1.insert(INSERT, " Valid room number(output in the terminal)!!! ""\n")
            else :

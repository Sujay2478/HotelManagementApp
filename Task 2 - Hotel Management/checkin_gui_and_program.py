...
#https://stackoverflow.com/questions/13070065/creating-buttons-with-python-gui 
#https://www.programmersought.com/article/97748006413/ 
#https://www.kite.com/python/docs/tkinter.ttk
...
# main list which will store the complete information on the customer 
guest_details_list =[]

# function for saving the database of the infromation regarding the guests 
def file_save():
    NAME_PRO = guest_details_list[0]
    ADDRESS_PRO = guest_details_list[1]
    MOBILE_NO_PRO = guest_details_list[2]
    ROOM_NO_PRO = guest_details_list[3]
    PRICE_PRO = guest_details_list[4]
    f = open("hotel.dat", "ab")
...
#different room numbers based on the type of room 
u = list()
...
m = [9]
G = [] 
#this code was taken from https://stackoverflow.com/questions/14907067/how-do-i-restart-a-program-based-on-user-input 
def restart_program():
...
# saves the information of guest being inputted 
class save:
...
#common class for the checkin page 
    ...
    def __init__(self):
        ...
        def chk_mo():
            while True:
                ...
                if self.h.isdigit() == True and len(self.h) != 0 and len(self.h) == 10:
                    ...
                    self.Text1.insert(INSERT, "Invalid input!! Please input a valid mobile number with 10 digits ONLY!!""\n")
                break
        # checks if the number of days the guests is staying is valid 
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT, "Number of days has been inputed!!""\n")
                    break
                else:
        ...
        def tor(self):
            ...
            if self.ch == 1:
                ...
                m[0] = 4
        #different payment option with or without disscount 
        ...
        def bill(self):
            ...
            guest_details_list.append(self.name)
            guest_details_list.append(self.address)
            guest_details_list.append(self.mobile_no)
            guest_details_list.append(self.room)
            guest_details_list.append(self.price)
...
#editing of the pannel 
# accepting input and showing the output 
        '''This class configures and populates the toplevel window.
           topa is the toplevel contining window.'''
        ...
        self.Message1.configure(text='''Current Page''')

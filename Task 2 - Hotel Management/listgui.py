...
import os
import pickle
#commmon list containing the information of the guest 
guest_details_list=[]
l2=[]
G = []
#saves the info regarding guest in the database 
def file_save():
...
#the main window  
# lists (outputs) the list of guest and their respective room number 
